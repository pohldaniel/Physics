...
KinematicCharacterController : public btCharacterControllerInterface
{
protected:
...
public:
	...
	void warp(float posX, float posZ);
	...
	void setDownVelocity(btScalar downVelocity);
	btScalar getDownVelocity() const;
